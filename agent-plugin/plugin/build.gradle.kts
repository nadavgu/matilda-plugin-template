...
dependencies {
    ...
    add("kspJvm", "org.matilda:commands-generator:$matildaVersion")
        ...
        all().configureEach {
            ...
            plugins {
                create("pbandk") {
                    ...
                    val outputDir = this@configureEach.getOutputDir(this)
                    project.kotlin.sourceSets.commonMain.configure {
                        ...
                        kotlin.srcDir(project.files(outputDir).builtBy(this@configureEach))
                    }
                }
            }
        }
